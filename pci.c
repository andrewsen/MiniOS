...
void PrintPCIDevHeader(u32 bus, u32 dev, u32 func, PCIDevHeader *p_pciDevice)
{
    ...
    printf("bus=0x%x dev=0x%x func=0x%x venID=0x%x devID=0x%x code=0x%x",
            bus, dev, func, p_pciDevice->option.vendorID, p_pciDevice->option.deviceID, p_pciDevice->option.classCode);
