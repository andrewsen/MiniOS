...
extern "C" int old_vm_entry(int argc, char *argv);
extern "C" int vm_entry(int argc, char **argv);
...
public:
    ...
    const static int _EXIT_FAILURE = -1;
    const static int _EXIT_SUCCESS = 0;
...
public:
    ...
    /* FRIEND FUNCTIONS */
    friend void internalExec(Runtime* rt, Function *f, byte* fargs);
    friend void internalInit(Runtime* rt, Function *f, byte* fargs);
    friend void internalLoadUI(Runtime* rt, Function *f, byte* fargs);
    friend void internalFindElement(Runtime* rt, Function *f, byte* fargs);
    friend void internalGetName(Runtime* rt, Function *f, byte* fargs);
    friend void internalGetText(Runtime* rt, Function *f, byte* fargs);
    friend void internalSetText(Runtime* rt, Function *f, byte* fargs);
    friend void internalGetColor(Runtime* rt, Function *f, byte* fargs);
    friend void internalSetColor(Runtime* rt, Function *f, byte* fargs);
    friend void internalGetTextColor(Runtime* rt, Function *f, byte* fargs);
    friend void internalSetTextColor(Runtime* rt, Function *f, byte* fargs);
    friend void internalGetPos(Runtime* rt, Function *f, byte* fargs);
    friend void internalSetPos(Runtime* rt, Function *f, byte* fargs);

    friend void internalReboot(Runtime* rt, Function *f, byte* fargs);
    friend void internalShutdown(Runtime* rt, Function *f, byte* fargs);

    friend void internalItoa(Runtime* rt, Function *f, byte* fargs);
    friend void internalDtoa(Runtime* rt, Function *f, byte* fargs);
    friend void internalAtoi(Runtime* rt, Function *f, byte* fargs);
    friend void internalAtod(Runtime* rt, Function *f, byte* fargs);
    ...
    Function* FindFunction(const char *name, RTType args[], uint count) const;
